...
export default function successPage() {
    ...
    return(
        <div className="container xl:max-w-screen-xl mx-auto py-12 px-6 text-center">
            {error ? (
                <div className="p2 rounded-md bg-rose-100 text-rose-500 max-w-md mx-auto">
                    <p className="text-lg">Sorry, something went wrong!</p> 
                </div>
            ) : !data ? (
                <div className="p2 rounded-md bg-gray-500 max-w-md mx-auto">
                ...
                <div className="py-4 px-8 space-y-4 rounded-md max-w-lg mx-auto">
                    ...
                    <p className="text-lg">
                        Check yur email ({email}) for your invoice.
                    </p>
                </div>
            )}
        </div>
